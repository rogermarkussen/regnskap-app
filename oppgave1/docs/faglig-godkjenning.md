...
| Testlab `7114` | Viser alle kostnader på konto `5000–7834` for prosjektet | Skal kortet vise ADK eller alle kostnader for prosjektet? | **Godkjent 06.08.2026:** alle kostnader |
...
1. Godkjenn periode og innhold for `154345` og Testlab – 10 minutter.
2. Godkjenn lønnsandel og budsjettmapping – 10 minutter.
3. Kontroller `5404/5405` og manglende kontoer – 10 minutter.

## Ferdig når

- alle fire KPI-beslutninger er skrevet inn i tabellen;
